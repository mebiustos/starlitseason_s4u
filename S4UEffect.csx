...
public class S4UEffect
{
    ...
    private const int WAIT_TIME_AFTER_DOWN = 10;
    private const int WAIT_TIME_AFTER_UP = 50;
    private const int INTO_ITEMLIST_AFTER_WAIT = 100;
    ...
    private Point CreateCodeCore(int slot, int type) {
        ...
        Tap(Keys.Enter);
        _globals.Wait(INTO_ITEMLIST_AFTER_WAIT);
    ...
    private void Tap(Keys key) {
        _globals.Tap(key, WAIT_TIME_AFTER_DOWN, WAIT_TIME_AFTER_UP);
    }
}